...
const categories = [
  { title: 'Pre Weddings', subtitle: 'The world spoke about us', cover: '/portfolio/16.png' },
  ...
  { title: 'Overseas', subtitle: 'Soumya Vish', cover: '/portfolio/11.png' },
          ...
          {categories.map((c, idx) => (
            <Reveal key={c.title} delay={0.03 * idx}>
              <button
                ...
                className="group relative overflow-hidden bg-noir-900 ring-1 ring-black/10"
              ...
              >
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  className="h-72 w-full object-cover opacity-90 transition duration-700 group-hover:scale-[1.03] group-hover:opacity-100"
                />
